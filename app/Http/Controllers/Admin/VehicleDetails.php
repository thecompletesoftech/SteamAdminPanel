...
class VehicleDetails extends Controller
{
    ...
    public function __construct()
    {
        ...
        //Data
        $this->uploads_image_directory = 'files/VehicleBrand';

        //route

        $this->index_route_name = 'admin.vehicle.index';
        $this->create_route_name = 'admin.vehicle.create';
        $this->detail_route_name = 'admin.vehicle.show';
        $this->edit_route_name = 'admin.vehicle.edit';

        //view files

        $this->index_view = 'admin.vehicle.index';
        $this->create_view = 'admin.vehicle.create';
        $this->edit_view = 'admin.vehicle.edit';



        //service files
        $this->service = new VehicleDetailsService();
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            return view('admin.vehicle.index', ['location' => $items]);
        }
    }
    ...
    {
         $Category = VehicletypeModal::where([ 'deleted_at' => null])->get();
    ...
    public function store(Request $request)
    {
        ...
        $input['vehicle_image'] = $this->uploads_image_directory . "/" . $filename;
