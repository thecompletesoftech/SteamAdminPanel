...
class CategoryController extends Controller
{
    ...
    public function __construct()
    {
        ...
        //Data
        $this->uploads_image_directory = 'files/Category';

        //route

        $this->index_route_name = 'admin.category.index';
        $this->create_route_name = 'admin.category.create';
        $this->detail_route_name = 'admin.category.show';
        $this->edit_route_name = 'admin.category.edit';
    ...
    public function index(Request $request)
    {
        ...
        if($request->ajax())
        {
            return view('admin.category.location_table',['location'=>$items]);
        } else {
            return view('admin.category.index',['location'=>$items]);
        }
    ...
    public function destroy($id)
    {
        ...
        $result=CategoryService::deleteLocation($id);
    ...
    public function status($id,$status)
    {
        ...
        $result=CategoryService::updateById(['status'=>$status],$id);
        return redirect()->back()->withSuccess('Location Delete Successfully!');
