...
@section('content')
    ...
    @include('admin.layouts.components.header', [
        'title' => __('messages.create', ['name' => trans_choice('content.location', 1)]),
        'breadcrumbs' =>'',
    ])
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex flex-column flex-lg-row">
                        ...
                        <div class="flex-lg-row-fluid me-0 me-lg-20">
                            ...
                            {!! Form::open(['route' => 'admin.vehiclebrand.store', 'method' => 'POST', 'class' => 'form', 'enctype' => 'multipart/form-data']) !!}

                            @include('admin.vehiclebrand.form')
