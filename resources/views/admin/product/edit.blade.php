...
@section('content')
    ...
    @include('admin.layouts.components.header', [
        ...
        'breadcrumbs' => Breadcrumbs::render('admin.product.edit'),
    ])
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex flex-column flex-lg-row mb-17">
                        ...
                        <div class="flex-lg-row-fluid me-0 me-lg-20">
                            <!--begin::Form-->
                            {!! Form::model($location, ['method' => 'PATCH', 'route' => ['admin.product.update', $location->id], 'class' => 'form mb-15', 'enctype' => 'multipart/form-data']) !!}
                            @csrf
