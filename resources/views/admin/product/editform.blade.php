...
<div class="card-body">
    ...
    <div class="row mb-6">
        ...
        <label class="col-lg-2 col-form-label required fw-bold fs-6">{{ trans_choice('content.product', 1) }}</label>

        <div class="col-lg-4 fv-row">
                {!! Form::text('service_name', null, ['min' => 2, 'max' => 6, 'value' => 2, 'class' => 'form-control form-control-lg form-control-solid', 'placeholder' => trans_choice('content.product', 1)]) !!}
        </div>
