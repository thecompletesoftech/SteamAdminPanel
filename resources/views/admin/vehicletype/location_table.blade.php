...
<table class="table align-middle table-row-dashed fs-6 gy-5">
  ...
  <tr>
    ...
    <td>
        ...
        <a  onclick="return confirm('Are you sure you want to delete ?')"  href="{{ url('/') }}/admin/vehicletype/destroy/{{$user->id}}" title="Delete" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" >
                    <span class="svg-icon svg-icon-3">
